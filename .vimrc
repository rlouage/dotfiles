...
""" latex stuff """
    ...
    " Open corresponding.pdf
        map <leader>p :!qpdfview <c-r>%<CR><CR>
    " Compile document using pdflatex:
        autocmd FileType tex inoremap <leader>c <Esc>:!pdflatex synctex=1 -interaction=nonstopmode  <c-r>%<Enter>a
        autocmd FileType tex nnoremap <leader>c :!pdflatex synctex=1 -interaction=nonstopmode  <c-r>%<Enter>
    " Code snippets
